...
if answer == "2"
 puts "Are you testing for your best friend or lover?"
 test_bff_lover = gets.strip.capitalize
 if test_bff_lover = "Best friend"
   puts "Check if you are meant to be!"
        puts "What is their sign?"
        bff_sign = gets.strip.capitalize 
        bff_compat.each do |key,value|
        if "#{key}" == "#{value}"
          puts "Great, your friendship will last a lifetime"
        else 
          puts "Sorry, try to find another"
  end
  end 
end 
end 
